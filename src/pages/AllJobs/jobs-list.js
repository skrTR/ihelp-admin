...
const JobsList = () => {
  //meta title
  document.title = "Job List | Skote - React Admin & Dashboard Template"
  ...
  const validation = useFormik({
    ...
    onSubmit: values => {
      if (isEdit) {
        ...
        // update job
        dispatch(onUpdateJob(updateJob))
      } else {
        const newJob = {
            ...
            <Col lg="12">
              <div>
                <div className="table-responsive">
                  <Table className="job-list-table table-nowrap align-middle table-borderless">
                    <thead>
                      <tr>
                    ...
                    <tbody>
                      {map(jobs, (job, index) => (
                        <tr key={index}>
                          ...
                          <td> {handleValidDate(job.dueDate)}</td>
                          <td>
                            <Badge className={"bg-" + job.color}>
                              {job.status}
                            </Badge>
                          </td>
                          <td>
                            <div className="avatar-group">
                              {map(job.team, (member, index) =>
